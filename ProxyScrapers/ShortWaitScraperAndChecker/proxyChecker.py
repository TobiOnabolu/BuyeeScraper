...
def check(inputFile, timeout, method, site, verbose, random_user_agent, outputFile):
    proxies = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--inputlist", help="Path to your proxy list input File", default="../allProxies.txt") # Grab List of Proxies
    parser.add_argument("-o", "--outputlist", help="Path to your proxy list out File", default="../workingProxies.txt") # Output List of working Proxies
    ...
    check(inputFile=args.inputlist, timeout=args.timeout, method=args.proxy, site=args.site, verbose=args.verbose,
          random_user_agent=args.random_agent, outputFile=args.outputlist)
